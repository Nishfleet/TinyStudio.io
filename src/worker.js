...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <p>The old TinyStudio app has been retired, and so has the self-serve Agent Desk. TinyStudio.io's current offer is the Website Appraisal: the free leak audit of high-ticket service homepages.</p>
    ...
    Response.json(
      {
        ok: false,
        status: "retired",
        message: "The old TinyStudio API has been retired, and so has the self-serve Agent Desk. TinyStudio.io's current offer is the Website Appraisal: the free leak audit of high-ticket service homepages.",
