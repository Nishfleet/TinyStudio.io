# PR #42 + #43 serial-merge review item — re-verification (2026-08-21)
...
repository state on 2026-08-21. This is a state verification of the
...
(PR #146, head 4e2b94c, 2026-08-12), and the prior re-verifications live at
`docs/evidence/pr42-pr43-serial-merge-rereverify-2026-08-14.md` (PR #189,
head 65347958, 2026-08-14) and
`docs/evidence/pr42-pr43-serial-merge-rereverify-2026-08-17.md` (PR #244,
head 4b48ef9, 2026-08-17).
...
## What the re-verification found (GitHub, 2026-08-21)
...
| Ancestor on current main (`92d55c3`) | yes — `git merge-base --is-ancestor 95d2248a origin/main` is true | yes — `git merge-base --is-ancestor ad9cee3 origin/main` is true |
...
- `public/llms.txt` carries the `## Answer Readiness: Preferred Source Pages`
  ...
  the 2026-08-12 closeout and the 2026-08-14/2026-08-17 re-verifications
  already accounted for that addition, and the present re-check confirms it
  is still present (`grep -c "q8-conversion-audit" public/llms.txt` → 1).
...
- The branch tip `ed62202e` is the second parent of merge commit
  ...
  receipts under `docs/evidence/ai-search/2026-08-09-controlled-rerun.md`
  and `docs/evidence/ai-search/2026-08-11-q5-ground-truth-alignment.md`
...
### Four-day-on state check (2026-08-17 → 2026-08-21)

Since the 2026-08-17 re-verification at head `4b48ef9` / main `f309dd45`,
the post-reverification commits on main have touched:

- The site surface (apple-touch-icon guard 92d55c3, /pricing lead-form
  tap targets 75cfef2, render-blocking re-verification 92b4354,
  product-contract round-1 harvest 8bc4f69, canonical re-verifications).
- The re-verification receipts themselves (apple-touch-icon, favicon rel,
  render-blocking, social-share, canonical URL, tap-target, broken-external
  links, g2/goodfirms/clutch profiles, product-contract harvest).
- Later AI-search evidence layers: the 2026-08-15 controlled re-run
  (`docs/evidence/ai-search/2026-08-15-controlled-rerun.md`, PR #227)
  recorded the first `Found` transitions and landed on main after PR #43.
...
`origin/main` at `92d55c3` (PR #256 merge, 2026-08-20) is the head against
which this re-verification is run. The local checks below were executed
against this head:
...
(2026-08-21); the closeout first recorded on 2026-08-12 (PR #146,
`4e2b94c`) and the re-verifications recorded on 2026-08-14 (PR #189,
`65347958`) and 2026-08-17 (PR #244, `4b48ef9`) still hold, with both PRs
merged in serial order, both PR contents on main, the q8-conversion-audit
extension and the post-2026-08-17 layers (apple-touch-icon guard, /pricing
lead-form tap targets, 2026-08-15 controlled re-run with first `Found`
transitions) layered on top of PR #42 + #43 without conflict, and no
further action needed beyond this receipt. The branches
