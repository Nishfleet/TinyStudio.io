# NEEDS-NISH — 2026-08-20 — TinyStudio.io

Scout timestamp: 2026-08-20T02:32:45.323Z
Product: TinyStudio.io
Source: var/scout/CANDIDATES-2026-08-20-TinyStudio.io.md
...
retargeting, no "your audit is ready" desk-bridge email.
...
high-ticket service buyers searching for audit/appraisal providers.
...
**Evidence:**
- `src/worker.js` lines 1428–1455 — tag injected only when both env vars are well-formed
...
- `specs/003-wellness-clinic-launch/tracking-setup.md` — documents the `wrangler secret put` steps
